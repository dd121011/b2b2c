...
package com.shopping.core.security.util.salt;
 ...
 *
 * @author Ben Alex
 * @version $Id: SaltSource.java 2217 2007-10-27 00:45:30Z luke_t $
 */
public interface SaltSource {
     ...
     *
     * @param userDetails from the <code>AuthenticationDao</code>
     *
